            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="{{url('account/orders')}}"><i class="fa fa-user"></i> Minha conta</a></li>
                            <li><a href="{{url('checkout/placeorder')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                            <li><a href="{{url('cart')}}"><i class="fa fa-shopping-cart"></i> Carrinho</a></li>
                            @if (Auth::guest())
                            <li><a href="/auth/login"><i class="fa fa-lock"></i> Login</a></li>
                            @else
                             <li><a href="/auth/logout"><i class="fa fa-sign-out" aria-hidden="true"></i>Sair</a></li>
                            @endif
                        </ul>
                    </div>
                </div>
